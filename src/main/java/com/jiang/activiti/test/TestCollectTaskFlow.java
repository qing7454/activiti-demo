 ...
 *
 */
public class TestCollectTaskFlow implements ActivitiConstants {
...
//		repositoryService = (RepositoryService) ctx.getBean("repositoryService");
	...
	public static void deploy() {
		...
		// 获取在classpath下的流程文件
		InputStream in = TestCollectTaskFlow.class.getClassLoader().getResourceAsStream("flow/task/collect-task-flow.zip");
...
//		repositoryService.createDeployment().addClasspathResource("config/flow/collect-task-flow.bpmn").deploy();
	...
	public static void flow1() {
		...
		String proposerUser = "boss";
		String applyUser = "jiangyg";
		...
		// jiangyg提交采集任务
		runtimeService.startProcessInstanceByKey(COLLECT_TASK.FLOW_NAME, map);
